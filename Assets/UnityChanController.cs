...
public class UnityChanController : MonoBehaviour
{
    ...
    //アニメーションするためのコンポネートを入れる。Animator型の変数名myAnimator。
    private Animator myAnimator;

    //（追加）Unityちゃんを移動させるコンポーネントを入れる。Rigidbody型の変数名myRgibody。
    ...
    void Start()
    {
        ...
        //走るアニメーションを開始
        //Animatorクラスの「SetFloat」関数は、第一引数に与えられたパラメータに、
        //第二引数の値を代入する関数です。
        //また、第一引数のバラメータがアニメーション再生の条件に使われています。 
        this.myAnimator.SetFloat("Speed", 1);

        //（追加）Rigibodyコンポーネントを取得
